...
{:.notice}
**How do you create these animations?** My strategy is embarrassingly simple and probably not optimal since I am not a graphics designer. That said, since I heard this question multiple times already, I think I should put my pride aside and offer a public response for this in case others may want to use a similar strategy to create new material. My workflow has three main steps and the trick here is to think backwards. First, I draw the entire concept on my tablet computer manually (I use a graphics editor called ProtoSketch, but any editor that can export SVG files will do just fine). Then, I step by step remove parts from the SVG and export PNG images of identical size (I use [Inkscape](https://inkscape.org/) for this, and you should, too (smiley): it is an open-source vector graphics editor that needs your support and will serve you well). Finally, I import the resulting PNG images into slides in reverse order so I can advance them to slowly introduce a given concept.
