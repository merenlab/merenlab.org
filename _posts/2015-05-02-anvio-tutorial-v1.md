...
{: .notice}
You should really consider upgrading your anvi'o to <b>[v2]({% post_url 2016-06-22-anvio-tutorial-v2 %})</b>.
...
If you are here, you must have already installed the platform, and have [run the "mini test"]({% post_url 2015-05-01-installation-v1 %}) succesfully.
...
Please read [this article]({% post_url 2015-05-11-anvi-refine %}) for a comprehensive introduction to refinement capacity of anvi'o.
