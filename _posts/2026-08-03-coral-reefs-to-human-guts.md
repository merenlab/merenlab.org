...
noleftpanel: false
notoc: false
thumbnail: /images/thumbnails/2026-08-03-coral-reefs-to-human-guts.png
image:
  feature: https://merenlab.org/images/thumbnails/2026-08-03-coral-reefs-to-human-guts.png
  display: false
---

What makes human guts and coral reefs similar? They have no shared microbial taxa, shared host(s), or timescales, but they are both extremely complex ecosystems that offer the same microbial readouts when they are disturbed, and that has implications on where we should NOT look for answers.

Welcome to another episode of Meren's Monday morning procrastination, where Meren comes to work very early to get things done, and then checks his email to read the latest Google Scholar alerts, and ends up spending 3 hours reading and writing, and then brings you here, and now you also have to procrastinate. THANK YOU MEREN.


{% include IMAGE path="/images/thumbnails/2026-08-03-coral-reefs-to-human-guts.png" %}


Well, I just read a fresh preprint from [Marko Terzin](https://www.linkedin.com/in/marko-terzin-89844135a/) et al, titled "[No-take marine reserves promote oligotrophic reef bacterioplankton communities across the Great Barrier Reef](https://www.biorxiv.org/content/10.64898/2026.07.23.740257v1)".

{% include IMAGE path="/images/miscellaneous/2026-08-03-coral-reefs-to-human-guts/terzin-et-al.png" width=50 %}

A remarkable study that compares seawater microbes across 48 reefs on the Great Barrier Reef. Of these reefs, 23 are inside no-take marine reserves (i.e., specific zones where fishing and collecting are prohibited), and the remaining 25 are in zones open to fishing. And it is worth noting that this is a gradient of relatively mild pressure rather than pristine-versus-plundered: most of the fished reefs (20 of 25) sit in zones where everything but trawling is allowed.

What they find is that the microbes in protected waters have smaller genomes, lower GC content, and incomplete metabolic modules. They can't make their own B12, their own amino acids, and they depend on each other, consistent with their co-occurrence networks that are full of positive associations (i.e., these reefs have lots of microbes with 'low metabolic independence'). In contrast, microbes in fished waters are the opposite. They have bigger genomes, and encode complete biosynthetic pathways for essential compounds. They are self-sufficient (i.e., these reefs have lots of microbes with 'high metabolic independence').
...
What I see in Terzin et al, and what I see in Watson, Füssel, and Veseli et al is the following: microbes are the sentinels of the wellbeing of ecosystems they inhabit. They primarily report and respond. And the solutions we need to *fix* the broken ecosystems require us to fix the real problems rather than the messengers.
