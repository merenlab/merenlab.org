---
redirect_from:
  - /2026/04/15/unfalsifiable-by-design/
layout: post
authors: [meren, iva]
...
{:.notice}
To keep the focus of our blog post on the structural problems this work demonstrates for reproducibility of science, we limited our scientific discussion to the framing of claims relative to what the study designs can support, rather than attempting to evaluate the scientific findings themselves. Readers who would like to learn more about the broader question of whether and how the human microbiome relates to autism may find the perspective by Kevin J. Mitchell, Darren L. Dahly, and Dorothy V. M. Bishop a good start: "[Conceptual and methodological flaws undermine claims of a link between the gut microbiome and autism](https://www.cell.com/neuron/fulltext/S0896-6273(25)00785-8)".
