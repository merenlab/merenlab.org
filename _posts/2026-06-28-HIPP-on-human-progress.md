...
The purpose of this blog post is to reach out to **researchers in the humanities, social sciences, and basic sciences who are interested in marine systems in general**, and tell them about an experiment we are conducting at the [HIFMB](https://hifmb.de).
...
Why do I care about transdisciplinary work? Do I not have enough work already? Well, I do have *mountains* of work. That's what it means to be a Professor in Germany. I will pretend that I didn't hear that second question. But the first one is truly a difficult one to answer. Especially if I were to drop the boilerplate, off-the-shelf statements.
...
* [Human Progress](https://hifmb.de/institute/hipp/human-progress/) (2027)
...
{% include IMAGE path="/images/HIPP-on-human-progress/timeline.png" width="90" noborder="1" %}
...
The following is my extremely brief interpretation of the positions for the readers of this blog. [This link](https://hifmb.de/institute/hipp/human-progress/) contains much more detail about each project, as well as links to pages for full job description and the official application interface.

{:.warning}
If you have questions about any of these projects you are very much encouraged to reach out to PIs, or write to [Thilo Gross](https://hifmb.de/people/thilo-gross/) at thilo.gross [at] hifmb.de. Thilo put tremendous amount of time and effort to bring this HIPP call to fruition, and is the de facto person to answer any science questions related to it.
...
{:.notice}
**PIs:** [**Kristian Berg**](https://uol.de/en/kristian-berg) *(computational linguistics, word formation and spread)*, [**A. Murat Eren**](https://hifmb.de/people/a-murat-eren-meren/) *(computer science, microbial ecology)*, [**Kimberley Peters**](https://hifmb.de/people/kimberley-peters/) *(geography, marine governance)*, [**Thilo Gross**](https://hifmb.de/people/thilo-gross/) *(network science, complexity theory)*.
...
{:.notice}
**PIs:** [**Dagmar Freist**](https://uol.de/en/dagmar-freist) *(early modern global history, digital humanities)*, [**Thilo Gross**](https://hifmb.de/people/thilo-gross/) *(network science, complexity theory)*, [**Helmut Hillebrand**](https://hifmb.de/people/helmut-hillebrand/) *(empirical biodiversity research, plankton ecology)*, [**Maximilian Schich**](https://www.schich.info/) *(cultural data analytics, network science)*.
...
{:.notice}
**PIs:** [**Rossella Alba**](https://hifmb.de/people/rossella-alba/) *(marine policy, politics of modelling)*, [**Thilo Gross**](https://hifmb.de/people/thilo-gross/) *(network science, complexity theory)*, [**Mark Siebel**](https://uol.de/en/philosophie/prof-dr-mark-siebel) *(theoretical philosophy, epistemology, philosophy of science)*.
...
{:.notice}
**PIs:** [**Thilo Gross**](https://hifmb.de/people/thilo-gross/) *(network science, complexity theory)*, [**Barbara Moschner**](https://uol.de/en/barbara-moschner) *(psychology, motivation)*, [**Marius Sältzer**](https://uol.de/en/social-sciences/independent-studies-between-inclusion-and-exclusion/digital-social-science/prof-dr-marius-saeltzer) *(computational social science, political communication)*.
...
{:.notice}
**PIs:** [**Sina Farzin**](https://uol.de/en/social-sciences/independent-studies-between-inclusion-and-exclusion/sociological-theory/prof-dr-sina-farzin) *(sociological theory, narratives in academic and literary texts)*, [**Thilo Gross**](https://hifmb.de/people/thilo-gross/) *(network science, complexity theory)*, [**Anton Kirchhofer**](https://uol.de/en/anton-kirchhofer) *(English literature, science and narrative)*.
