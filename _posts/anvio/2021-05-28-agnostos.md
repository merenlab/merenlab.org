...
Now that we have imported the AGNOSTOS categories into our {% include ARTIFACT name="contigs-db" text="contigs database" %}, let's leverage them and explore Unknowns in metagenomic-assembled genomes (MAGs)!
