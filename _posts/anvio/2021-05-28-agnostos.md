...
Anyone who studies microbial life through genomes or metagenomes runs often in situations where they find a large proportion of the genes with no functional annotation. Indeed, as of today 40% to 60% of predicted genes from genomes or metagenomes have no significant homology to nucleotide databases. Which is only getting worse as we sequence more and more microbiomes from around the globe. To ameliorate the inaccessibility of genes of unknown functions, Vanni *et al.* ([2021](https://doi.org/10.1101/2020.06.30.180448)) have recently introduced [AGNOSTOS](https://github.com/functional-dark-side/agnostos-wf), which aims to help microbiologists to integrate all genes found in genomes and metagenomes into their ecological and evolutionary investigations. 

This recent work titled "[Unifying the known and unknown microbial coding sequence space](https://www.biorxiv.org/content/10.1101/2020.06.30.180448)" described [the AGNOSTOS workflow](https://github.com/functional-dark-side/agnostos-wf) sheds light into the unknown sequence landscape of microbiomes from oceans and the human body, revealing thousands of lineage-specific genes of unknown function in the CPR superphylum Patescibacteria. We strongly recommend anyone who is interested in this topic to read [this blog post](http://merenlab.org/2020/07/01/dark-side/), in which [Antonio Fernandez-Guerra](http://orcid.org/0000-0002-8679-490X) describes the origins of AGNOSTOS, categories of gene-clusters it produces, and the future of unknown genes in microbiomes.

We created this tutorial to demonstrate how to integrate AGNOSTOS gene categories into anvi'o projects using [AGNOSTOS-DB](https://doi.org/10.1101/2021.06.07.447314), a resource that aims to empower the science community to explore genes of unknown function in their own genome and metagenome sequence data.

{:.warning}
The tutorial is a work-in-progress. However, we continuously improve it, and please feel free to reach out to us if you have any questions.
...
<div class="extra-info" markdown="1"><span class="extra-info-header">AGNOSTOS gene categories</span>
