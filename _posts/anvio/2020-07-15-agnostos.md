...
How many times have you analyzed a metagenome and found that a large proportion of the genes have no annotation? 

Have you ever been interested in a genomic locus but it contains a critical gene that has no determined function?
...
Recently, Vanni et al., 2020 published the preprint [Light into the darkness: Unifying the known and unknown coding sequence space in microbiome analyses](https://www.biorxiv.org/content/10.1101/2020.06.30.180448v1) showcasing the Agnostos Workflow and describing the unknown sequence landscape of microbiomes from ocean and human body biomes. One of the goals of this manuscript was to provide a resource (workflow and dataset) for the community to explore genes of unknown function in their own microbial genomes and metagenomes. To create this dataset, briefly, the Agnostos workflow clustered open reading frames (ORFS) from 1,749 metagenomes and 28,941 bacterial and archaeal genomes, then systematically validated and categorized the clusters into Known and Unknown gene clusters. If you are more interested in the details of the manuscript please refer to the [preprint](https://www.biorxiv.org/content/10.1101/2020.06.30.180448v1). To accompany this manuscript, my former supervisor [Antonio Fernandez-Guerra](http://orcid.org/0000-0002-8679-490X) wrote a blog post that goes over the origins of the Agnostos worflow, the resulting categories of gene-clusters resulting from the workflow, and the future of Unknown genes in microbiomes. Check it out here: [blog post](http://merenlab.org/2020/07/01/dark-side/#a-conceptual-framework-to-unify-the-known-and-the-unknown-in-microbiome-analyses).

"Ok great, we have this fancy resource... but how do I use it? I have metagenomes I'm analyzing right now!"
 
To give you an introduction, we have composed a tutorial demonstrating how to use the workflow output from integrating ORFs from genomes and metagenomes into the [Agnostos Workflow](https://github.com/functional-dark-side/agnostos-wf) from [Vanni et al., 2020](https://www.biorxiv.org/content/10.1101/2020.06.30.180448v1) using anvio! To have some fun, [Chiara Vanni](https://orcid.org/0000-0002-1124-1147) kindly integrated all of the ORFs from the classic anvio metagenomic sandbox, the Infant Gut Dataset from [Sharon et al., 2013](http://www.ncbi.nlm.nih.gov/pubmed/22936250)(IGD). We will explore how the Agnostos categories can be used to get more out of both the IGD metagenomes and a pangenome of *E. faecalis*. 

**The goal of this tutorial is not to demonstrate an exhaustive case-study of how to use the Agnostos workflow, but rather a brief introduction.**
...
- `INFANT-GUT-TUTORIAL`:all the files needed for binning and pangenomics later in the tutorial
...
One can also visualize contigs with anvio using `anvi-inspect`?
