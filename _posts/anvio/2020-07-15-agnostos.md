...
Check out a description of the columns in the file [here]().
...
#anvi-import-functions -c CONTIGS.db -p agnostos -i IGD_agnostos/IGD_ext_genomes_summary_info_exp.tsv
anvi-script-reformat-agnostos-data --input IGD_agnostos/IGD_genes_summary_info_exp.tsv --output IGD
anvi-script-reformat-agnostos-data --input IGD_agnostos/IGD_ext_genomes_summary_info_exp.tsv --output external_genomes
```
...
anvi-gen-genomes-storage -i additional-files/pangenomics/internal-genomes.txt \
                         -e additional-files/pangenomics/external-genomes_efaecalis.txt \
