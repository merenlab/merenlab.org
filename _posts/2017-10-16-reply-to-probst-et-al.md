...
{:.notice}
Please feel free to visit [this post]({% post_url 2017-11-25-DWH-O-desum-v2 %}) to read about the technical details of the recovery of "DWH O. desum v2", or as we like to call it "_Ca_ Nobermanella desum", mostly because we are funny.
