...
Anvi'o also provides a simpler way to annotate your genes using NCBI COGs. If you would like to explore that option, please read [this article]({% post_url 2016-10-25-cog-annotation %}).
...
A recipe to work with Prokka by Antti Karkman is [available here]({% post_url 2017-05-18-working-with-prokka %}).


## KEGG Modules

A tutorial on how to import KEGG modules into an anvi'o contigs database by Elaina Graham is [available here]({% post_url 2018-01-17-importing-ghostkoala-annotations %}).
