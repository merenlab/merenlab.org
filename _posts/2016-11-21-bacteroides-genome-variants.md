---
redirect_from:
  - /2016/11/21/bacteroides-genome-variants/
layout: post
...
{:.notice}
To display the anvi'o merged profile mentioned in this section you will need to have the anvi'o `v2.0.2` available to you. If you are not interested in [installing anvi'o]({% post_url 2016-06-26-installation-v2 %}), you can use [the anvi'o Docker image]({% post_url 2015-08-22-docker-image-for-anvio %}) to run it on any major operating system. If you are [using anvi'o like a hacker]({% post_url 2016-06-26-installation-v2 %}/#installation-for-developers-youre-a-wizard-arry), you can simply go back to the right point in time in the codebase by typing `git checkout tags/v2.0.2`.
