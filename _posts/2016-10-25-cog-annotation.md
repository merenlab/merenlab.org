...
This is different than [importing functions into anvi'o]({% post_url 2016-06-18-importing-functions %}), because this workflow is run by anvi'o programs that use blastp or DIAMOND to search NCBI's now-quite-outdated-and-not-maintained-but-still-awesome COG database, and provides a one-step-solution for the functional annotation problem.
...
{:.notice}
{% include _fixthispage.html source="_posts/2016-10-25-cog-annotation.md" %}
