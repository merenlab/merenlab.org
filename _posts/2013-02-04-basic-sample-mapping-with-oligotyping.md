---
redirect_from:
  - /2013/02/04/basic-sample-mapping-with-oligotyping/
layout: post
authors: [meren]
...
The mapping file is essentially a TAB-delimited file that contains information about every sample you have in the analysis. For instance, this would be an appropriate mapping file for the mock samples used in [this article]({% post_url 2012-05-11-oligotyping-pipeline-explained %}):
