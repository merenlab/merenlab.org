...
{: .notice}
This installation manual is tailored for anvi'o <b>v1 branch</b>. We strongly urge you to <b>[install anvi'o v2]({% post_url 2016-06-26-installation-v2 %})</b> instead.
...
* [OS X installer for anvi'o]({% post_url 2015-08-20-installation-on-mac %}) (for Maverick and Yosemite).
* [Docker image for anvi'o]({% post_url 2015-08-22-docker-image-for-anvio %}) (for an instant, and painless installation of anvi'o on a server system).
...
* [Prodigal]({% post_url 2016-06-18-installing-third-party-software %}#prodigal){:target="_blank"}
* [HMMER]({% post_url 2016-06-18-installing-third-party-software %}#hmmer){:target="_blank"}
* [SQLite]({% post_url 2016-06-18-installing-third-party-software %}#sqlite){:target="_blank"}
* [GSL]({% post_url 2016-06-18-installing-third-party-software %}#gnu-scientific-library){:target="_blank"}
* [NumPY]({% post_url 2016-06-18-installing-third-party-software %}#numpy){:target="_blank"}
* [Cython]({% post_url 2016-06-18-installing-third-party-software %}#cython){:target="_blank"}
* [HDF5]({% post_url 2016-06-18-installing-third-party-software %}#hdf5){:target="_blank"}
...
Maybe you would like to continue with the [other posts on the platform](https://anvio.org)?
