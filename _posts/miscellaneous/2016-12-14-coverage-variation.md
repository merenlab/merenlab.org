...
We many times discussed ideas that may explain the underlying reasons for those patterns. Yet I don't remember even a single discussion where there was a consensus which brought satisfaction and happiness. Thank you, metagenomics.
...
When we first implemented the 'inspection' function for anvi'o and started seeing these coverage patterns, I had thought that these were mostly due to some magical fluidics phenomenon happening in the sequencer or something.
...
Besides binning, you can see that relying on gene average coverage values to study the functional potential of a given community may require some extra attention since it seems the coverage can change as much as an order of magnitude between GC-rich and GC-poor regions of the same population genome.
