...
Not surprisingly there is a great focus on metagenomics as it is the most relevant way to study naturally occurring viral communities via high-throughput sequencing. During the time we spent there, Tom and I often felt that [anvi'o](http://merenlab.org/software/anvio/) could be very useful for Rob and others. So we made sure Rob installed anvi'o before we left (smiley):
