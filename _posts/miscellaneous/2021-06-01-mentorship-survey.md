...
{:.notice}
**Visualizations in this blog post are fully reproducible** and generated by [this R markdown file](https://github.com/merenlab/mentorship-survey-workflow/blob/master/mentorship.Rmd) from the [survey results stored here](https://github.com/merenlab/mentorship-survey-workflow/blob/master/mentorship.tsv). By cloning [this repository](https://github.com/merenlab/mentorship-survey-workflow/) you can investigate the survey results yourself. If you are interested, you can send me a pull request to improve the representation of the survey results.
