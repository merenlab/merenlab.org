...
For anyone who doesn't know, a diazotroph is a microbe that fixes nitrogen. Nitrogen fixation is a very important process that supports all forms of life on Earth by recycling nitrogen molecules from the atmosphere into a biologically-usable form. It happens quite a lot in the global oceans, so to marine microbiologists, nitrogen-fixing microbes - that is, marine diazotrophs - are a Big Deal.

But not all marine diazotrophs have been getting attention. Cyanobacterial diazotrophs have long been thought to be the most abundant type of nitrogen-fixing microbes in the ocean, and therefore have been the focus of most research related to the subject. Until now. As Tom discusses in his paper, non-cyanobacterial diazotrophs - HBDs, to be specific - are actually more abundant than cyanobacterial ones, based on their genomic content in a vast collection of ocean metagenomes from the [TARA Oceans sampling effort](https://www.nature.com/articles/s41579-020-0364-5). That is really cool, yet these HBDs would never have made it into the limelight if Tom hadn't carefully combed through massive amounts of public data to find them.

The HBD story is the result of an immense effort by Tom, who _manually_ curated almost 2,000 metagenome-assembled genomes (MAGs) from co-assemblies of almost 800 ocean metagenomes, and then mined this MAG set for nitrogen fixation genes to find 48 diazotrophs. The standard marker for nitrogen fixation is the _nifH_ gene, but because this gene can occur in a variety of different contexts, it is necessary to find 6 different _nif_ genes to be sure of a microbe's nitrogen-fixing capabilities ([Dos Santos 2012](https://bmcgenomics.biomedcentral.com/articles/10.1186/1471-2164-13-162)). It was a crazy amount of work for Tom (we are all very impressed over here), and it shows that if you know what you are looking for and are willing to spend a lot of time and effort, you can be very successful at fishing through data.

Of course, not everyone is willing or able to bin thousands of MAGs just to find one population of interest. If that is your case, I am here to tell you that it doesn't need to be that hard. You can focus your efforts on the microbe(s) you care about, provided you know what distinguishes them metabolically from the other populations in their community. You can bin just 48 populations instead of 1,888. There is a different way, and that way involves {% include PROGRAM name="anvi-estimate-metabolism" %}.
...
One useful feature of this program is that you don't have to bin MAGs before running it - you can run it directly on your metagenomic assemblies. That means you can actually use its output to find contigs belonging to your population of interest, allowing you to perform _targeted binning_.
