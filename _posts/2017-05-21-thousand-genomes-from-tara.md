---
redirect_from:
  - /2017/05/21/thousand-genomes-from-tara/
layout: post
authors: [tom]
...
At the time, the analysis and visualization platform [anvi'o](https://anvio.org/) was in the process of being published, and Meren and I were __eager to test our new [manual metagenomic binning workflow](http://merenlab.org/2016/06/22/anvio-tutorial-v2/) on large and challenging datasets__. I immediately started playing with the TARA Oceans data, focusing on a size fraction we anticipated could be prone to good assemblies: the filters enriched in archaeal, bacterial and pico-eukaryotic cells.
