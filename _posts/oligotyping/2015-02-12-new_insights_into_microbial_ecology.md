...
[In their study](http://journal.frontiersin.org/Journal/10.3389/fmicb.2014.00526/full) Menke *et al*. compare the gut microbiomes of two sympatric mammalian carnivores, cheetah and black-backed jackal, by sequencing the V4 region of the 16S rRNA gene they amplified from fecal material collected from **free-ranging** animals!

Being sympatric, and having somewhat similar diets, these animals seem to have similar gut microbiomes in the big picture, yet their microbiomes are different enough in lower levels of taxonomy for them to separate from each other on an ordination. However, authors show that even genera that seem to be shared among the two are composed of different oligotypes. For instance *Blautia* is pretty abundant in both cheetah and jackal group, yet *Blautia* oligotypes differ dramatically between the two (cheetah samples are on the left) (Figure 6 from Menke *et al*.):
...
In this study, which I was a part of, Mark Welch *et al*. re-analyzes the infamous microbiome time series data published by [Caporaso *et al*.](http://www.ncbi.nlm.nih.gov/pubmed/21624126). We had recently [re-analyzed and published](http://www.pnas.org/content/111/28/E2875.full) the oral samples collected by the HMP project. The HMP data were mostly representing a cross-sectional sampling of a large group of individuals. The lack of multiple samples from each individual leaves many questions unanswered about the stability of the oral microbiome at the oligotypes level. For instance one of the interesting findings in our previous study was this (from Fig 4 in Eren *et al*.):
...
In this figure each bar represents one individual, and colors show the distribution of *Neisseria* oligotypes in that person's tongue. What is interesting about this figure is that each individual is dominated by one of the *Neisseria* oligotypes (almost all of which are 99% identical to each other at the sequenced region and binned together with conventional methods). So, what is going on here? Are they functionally identical? Do they represent different stable community states? Are some of those bars coming from transient states? If we had looked at one of those individuals for a long period of time, would we see a sudden switch in the *Neisseria* population? And most importantly, what governs these patterns? Neutral effects? The host immune system? Rest of the microbiome? All of the above? Or none?
...
{: .notice}
I wish colors were identical to the previous study, but sequencing different regions of the 16S rRNA gene makes it very very hard to connect things to each other confidently
...
There are a number of interesting things going on. At the very beginning of the sampling period, each individual is composed of one the Neisseria oligotype shown in green. Then they diverge into their own type, blue for female and cyan for male, and they stay like that! As a note, blue and cyan are one nucleotide apart from each other. Here is a note from the paper:
...
You can read the study here: [doi: 10.3389/fmicb.2014.00568](http://journal.frontiersin.org/Journal/10.3389/fmicb.2014.00568/full)
