---
redirect_from:
  - /2015/08/20/installation-on-mac/
layout: post
...
{:.warning}
This is petty old now, and we will not add new OS X installers. Please do not use this, and try Homebrew installation instructions you can find in [this post]({% post_url 2016-06-26-installation-v2 %}).
...
Do you see it? Now you can follow the [user tutorial]({% post_url 2016-06-22-anvio-tutorial-v2 %}) if you like.
