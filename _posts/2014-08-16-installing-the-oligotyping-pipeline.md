---
redirect_from:
  - /2014/08/16/installing-the-oligotyping-pipeline/
layout: post
authors: [meren]
...
{:.notice}
There is also a [docker image for oligotyping]({% post_url 2014-09-02-virtualbox %}) if you are interested in a painless run.
...
When the installation is done, you can refer to [this post]({% post_url 2012-05-11-oligotyping-pipeline-explained %}) to learn more about the use of the pipeline.
