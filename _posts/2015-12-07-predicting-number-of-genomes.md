---
redirect_from:
  - /2015/12/07/predicting-number-of-genomes/
layout: post
...
{:.warning}
**PLEASE USE `anvi-display-contigs-stats` for this task**. The rest of the post is here for historical reasons, but basically this functionality is now implemented in [this program](https://anvio.org/help/main/programs/anvi-display-contigs-stats/).
