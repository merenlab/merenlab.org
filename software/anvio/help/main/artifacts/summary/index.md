...
- The description of your database (which you can change with <span class="artifact-n">[anvi-update-db-description](/software/anvio/help/main/programs/anvi-update-db-description)</span>)
