...
It is required to run <span class="artifact-n">[anvi-run-ncbi-cogs](/software/anvio/help/7/programs/anvi-run-ncbi-cogs)</span> and is set up on your computer by the program <span class="artifact-n">[anvi-setup-ncbi-cogs](/software/anvio/help/7/programs/anvi-setup-ncbi-cogs)</span>. 
