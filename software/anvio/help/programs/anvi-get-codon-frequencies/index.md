...
<p style="text-align: left" markdown="1"><span style="background:#cbe4d5; padding: 0px 3px 2px 3px; border-radius: 5px;">[codon-frequencies-txt](../../artifacts/codon-frequencies-txt)</span> <span style="background:#cbe4d5; padding: 0px 3px 2px 3px; border-radius: 5px;">[aa-frequencies-txt](../../artifacts/aa-frequencies-txt)</span></p>
