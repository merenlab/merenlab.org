...
The internal genomes file format enables anvi'o to work with one or more bins from one or more collections that may be defined in different anvi'o <span class="artifact-n">[profile-db](/software/anvio/help/artifacts/profile-db)</span> files. A TAB-delimited internal genomes file will be composed of the following five columns:
