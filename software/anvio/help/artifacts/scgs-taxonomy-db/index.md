...
<p style="text-align: left" markdown="1"><span style="background:#cbe4d5; padding: 0px 3px 2px 3px; border-radius: 5px;">[anvi-setup-scg-databases](../../programs/anvi-setup-scg-databases)</span></p>


## Required or used by

<p style="text-align: left" markdown="1"><span style="background:#dcbfe8; padding: 0px 3px 2px 3px; border-radius: 5px;">[anvi-run-scg-taxonomy](../../programs/anvi-run-scg-taxonomy)</span></p>
