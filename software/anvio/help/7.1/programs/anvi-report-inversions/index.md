...
<p style="text-align: left" markdown="1"><span class="artifact-p">[inversions](../../artifacts/inversions) <img src="../../images/icons/CONCEPT.png" class="artifact-icon-mini" /></span></p>
...
{:.notice}
**No one has described the usage of this program** :/ If you would like to contribute, please see previous examples [here](https://github.com/merenlab/anvio/tree/master/anvio/docs/programs), and feel free to add a Markdown formatted file in that directory named "anvi-report-inversions.md". For a template, you can use the markdown file for `anvi-gen-contigs-database`. THANK YOU!
