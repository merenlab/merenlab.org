...
Please note that **preparation** and **participation** will play a key role in your success as usual. For an effective learning experience please consider (1) taking a brief look at the new analysis assignment (~30 minutes of study) on the Monday before class, (2) take time early on to try to complete the assignment by yourself (~2-4 hours of study), and (3) ask questions to Iva or others before it is too late (using Wednesday's discussion time wisely). Analysis tasks and data will be available on Stud.IP two weeks before the next session.
